<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex flex-col gap-24 pt-16">
    <span
...
<script setup>
  ...
  function spin() {
    ...
    if (shouldWin) {
      ...
      const losingIndex = losingIndices[Math.floor(Math.random() * losingIndices.length)]
      const angleInSlice = Math.random() * 45
