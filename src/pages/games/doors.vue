<template>
  <div class="min-h-screen flex flex-col items-center relative overflow-hidden pt-16">
    <!-- Crediti -->
    <span
    ...
    <div v-else-if="message" class="mt-10 text-2xl font-semibold text-gray-700 animate-fade">
      {{ message }}
    </div>
...
<script setup>
  ...
  function chooseDoor(index) {
    if (gameOver.value || win.value || doorOpen.value || credits.value === 0) return
